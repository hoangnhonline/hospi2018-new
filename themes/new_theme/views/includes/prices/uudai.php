<?php 
        ...
        <tr>
            ...
            <td rowspan="<?php echo $rowspan; ?>">
                ...
                <p class="size13" style="text-align: center;">Bạn vui lòng chọn số lượng phòng hoặc giường phụ (nếu có).<br> <span style="font-size: 11px">Giường phụ: <?php echo number_format($uuDaiTotal['bed']/$modulelib->stay); ?>/đêm</span> </p>
                <hr>
