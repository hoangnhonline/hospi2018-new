...
<div class="container">
  <div class="blog">
    <!-- Khuyen mai -->
    <div class="row">
      <div class="col-md-5 col-sm-5 col-xs-12 blog-items hidden-xs">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12 blog-items" style="padding-right: 0px">
        <div class="form-group">
  ...
  <!-- <?php $honeymoonLocation = honeymoonWithLocations(3); if(!empty($honeymoonLocation)) { ?>
    ...
    <?php } ?>-->
  <div class="hotels-by-location hidden-xs">
    <!-- Khuyen mai -->
    <div class="row">
