...
<div class="wrap ctup">
 ...
 <!--<div class="img-banner visible-xs">
              <img src="assets/img/1512967959_Emeral-Ninh.png" class="img-responsive">
            </div>-->
   <div class="banner-khuyenmai col-md-8 col-sm-12 col-xs-12 wow fadeInUp animated why-img visible-xs">
        <div id="carousel-widget" class="carousel slide" data-ride="carousel">
          <!-- Wrapper for slides -->
          <div class="carousel-inner">
                        <div class="item">
              <a href="https://www.hospi.vn/hotels/vietnam/ninh-thuan/khach-san-amanoi-resort?"><img alt="" src="https://www.hospi.vn/uploads/cms/images/1512967817_Amanoi-Ninh-Thuan.png"></a>
            </div>
                        <div class="item">
              <a href="https://www.hospi.vn/hotels/vietnam/con-ao/six-senses-con-dao-resort?"><img alt="" src="https://www.hospi.vn/uploads/cms/images/1512967899_Sex-senses-con-dao.png"></a>
            </div>
                        <div class="item active">
              <a href="https://www.hospi.vn/hotels/vietnam/a-nang/intercontinental-danang-sun-peninsula-resort?"><img alt="" src="https://www.hospi.vn/uploads/cms/images/1512967937_Intercontinatal-da-nang.png"></a>
            </div>
                        <div class="item">
              <a href="https://www.hospi.vn/hotels/vietnam/ninh-binh/emeralda-resort-ninh-binh?"><img alt="" src="https://www.hospi.vn/uploads/cms/images/1512967959_Emeral-Ninh.png"></a>
            </div>
                      </div>
          <!-- Indicators -->
          <ol class="carousel-indicators hidden-xs">
                        <li data-target="#carousel-widget" data-slide-to="0" class=""></li>
                        <li data-target="#carousel-widget" data-slide-to="1" class=""></li>
                        <li data-target="#carousel-widget" data-slide-to="2" class="active"></li>
...
<div class="container"   >
     <div class="block-slide hidden-lg"  style=" margin-bottom: 15px;margin-top: -10px">
          <div class="banner-khuyenmai">
            <div id="carousel-banner-rt" class="carousel slide" data-ride="carousel">
              ...
              <!-- Indicators -->
              <ol class="carousel-indicators hidden-xs">
               <?php  $k=1; foreach($pics[0] as $pic) { ?>
                <li data-target="#carousel-banner-rt" data-slide-to="<?php echo $k ?>" class="active"></li>
               <?php $k++;} ?>
              </ol>
            <!-- Carousel -->
          </div>
  ...
  <div class="container">
    <div class="block-content">
      ...
      <ul class="list-inline list-enj">
          ...
          <li><a href="<?php echo base_url()?>bestchoice" title="Khuyến mãi" class="another-color">Bestchoice</a></li>
          <li><a href="<?php echo base_url()?>combo" title="Combo" class="another-color">Combo</a></li>
