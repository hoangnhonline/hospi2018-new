...
<div class="offer-banner-bottom">
    ...
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="khuyen-mai"><a class="active" href="<?php echo base_url();?>bestchoice">"><?php echo trans('0558'); ?></a></span></div>
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="bestchoice"><a href="<?php echo base_url();?>combo"><?php echo trans('0559'); ?></a></span></div>
  ...
  <div class="offer-page rightcontent col-md-9 offset-0">
    <div class="itemscontainer offset-1">
        <div class="offset-2">
            ...
            <div class="gray-txt opensans"><?php echo trans('0597'); ?></div>
        ...
        <div class="place-row">
            <div class="place-cell"><h3 class="sub-title go-right"><?php echo trans('0589'); ?></h2></div>
            <div class="place-cell"><h3 class="sub-title go-right"><?php echo trans('0590'); ?></h2></div>
            <div class="place-cell"><h3 class="sub-title go-right"><?php echo trans('0599'); ?></h2></div>
            <div class="place-cell"><h3 class="sub-title go-right"><?php echo trans('0591'); ?></h2></div>
            <div class="place-cell"><h3 class="sub-title go-right"><?php echo trans('0600'); ?></h2></div>
        </div>
      <?php if(!empty($salesoffHotels)){ foreach($salesoffHotels as $item){ ?>
            <div class="place-row childrow">
                <div class="place-cell"><a class="sub-menu-link" href="<?php echo $item->slug; ?>" target="_blank"><?php echo $item->title; ?><?php echo $item->stars; ?>
                        <div class="header-featured-hotel-address opensans"><?php echo $item->mapAddress; ?></div></a>
                </div>
