...
<!--<input type="hidden" name="checkin" value="<?php echo $modulelib->checkin; ?>" />-->
                ...
                <?php } ?>
                                                    ...
                                                    <hr><div class="carousel magnific-gallery row">
                ...
                <?php if ($r->price > 0) { ?>
                                                                <span class="purple size18"><?php if ($module->price_status == 'Yes') { if($r->issale>0 && $r->onsale==true) echo "<b>". $r->saleprice ."</b>"; else echo "<b>". $r->price ."</b>"; ?>
