...
<!--//secondary-->
  ...
  <div class="rightcontent col-md-9 offset-0">
    <div class="itemscontainer offset-1">
        <div class="col-md-12"><h2 class="tour-title go-right andes-bold"><?php echo trans('0770');?></h2></div>
        ...
        <div class="clearfix"></div>
        <div class="col-md-12"><h2 class="tour-title go-right andes-bold"><?php echo trans('0771');?></h2></div>
