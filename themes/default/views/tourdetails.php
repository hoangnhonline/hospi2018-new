    ...
    <div class="secondary col-md-3 go-right">
            ...
            <!--<hr>
                ...
                <form  action="<?php echo base_url() . $appModule; ?>/book/<?php echo $module->bookingSlug; ?>" method="GET" role="search">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button style="border-radius: 10px; margin: 3px;" type="submit" class="btn btn-block btn-action btn-lg"><?php echo trans('0778'); ?></button>
                        </div>
                    </div>
                </form>
            <?php } ?>
        ...
        <?php if (!empty($module->relatedItems)) { ?>
            ...
            <div class="list-group">
                <div class="panel panel-default related-box">
            ...
            <div class="panel panel-default">
                ...
                <div class="tab-content" style="padding:0;"> 
                    ...
                    <div class="tab-pane" id="partner">
                        <div style="display: inline-block;width: 100%;padding: 20px;">
                            <?php if (!empty($module->operator)) { ?>
                                <?php echo "<div>".trans('0820')."<span class='purple'>".$module->operator."</span></div>"; ?>
                            <?php } ?>
                            <?php if (!empty($module->address)) { ?>
                                <?php echo "<div>".trans('098').": ".$module->address."</div>"; ?>
                            <?php } ?>
                        </div>
                    </div>
