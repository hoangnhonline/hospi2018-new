...
<div class="offer-banner-bottom">
    ...
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="khuyen-mai"><a class="active" href=""><?php echo trans('0558'); ?></a></span></div>
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="bestchoice"><a href="<?php echo base_url();?>offers/bestchoice"><?php echo trans('0559'); ?></a></span></div>
