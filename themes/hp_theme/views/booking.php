		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="center-block">
					<center>
						<button class="btn btn-circle block-center btn-lg btn-success"><i class="fa fa-check"></i>
						</button>
						<h3 class="text-center"><?php echo trans('0409'); ?>
							<b class="text-success wow flash animted animated"><?php echo trans('0135'); ?></b></h3>
						...
						<?php if (!empty($nightlyRateTotal)) { ?>
							<p><strong>Total Nightly Rate: <?php echo $currency . " " . $nightlyRateTotal; ?></strong>
							</p>
						<?php } ?>
						...
						<?php if (!empty($HotelOccupancyTax)) { ?>
							<p>><strong>Hotel Occupancy
									Tax: <?php echo $currency . " " . $HotelOccupancyTax; ?></strong></p>
						<?php } ?>
						<?php if (!empty($TaxAndServiceFee)) { ?>
							<p><strong>Tax and Service Fee: <?php echo $currency . " " . $TaxAndServiceFee; ?></strong>
							</p>
						<?php } ?>
						<p><b>  <?php echo trans('0124'); ?> :</b> <?php echo $currency . $grandTotal; ?>
							(<?php echo trans('0538'); ?>) </p>
						<p><?php echo trans('0537'); ?> </p>
						<?php if (!empty($checkInInstructions)) { ?>
							<p><strong><?php echo trans('0458'); ?></strong>
								: <?php echo strip_tags($checkInInstructions); ?></p>
						<?php } ?>
		...
		<div class="container mt25 offset-0">
								...
								<form id="bookingdetails" action="" onsubmit="return false">
									...
									<div class="panel panel-default">
										<div class="panel-heading no-padding">
											<div class="hospi-heading"><?php echo trans('0602'); ?></div>
										</div>
										<div class="panel-body">
											...
											<nav id="tab" class="segmented btn-group checkout-group-tab">
												<?php foreach ($paymentGateways as $pay) {
													if ($pay['name'] != "payonarrival") { ?>
            ...
            <?php }*/ ?>
								...
								<div class="form-group">
									...
									<button type="submit" class="btn btn-action btn-lg btn-block completebook" style="font-size:18px" name="<?php if (empty($usersession)) {
										echo "guest";
									} else {
										echo "logged";
							...
							<?php } else {
								if ($nonRefundable) { ?>
									<div class="alert alert-danger"> This rate is non-refundable and cannot be changed
										or cancelled - if you do choose to change or cancel this booking you will not be
											...
											<div class="step">
												...
												<div class="col-md-6  go-left">
													<div class="form-group ">
														...
														<input id="card-holder-state" class="form-control form" type="text" placeholder="<?php echo trans('0101'); ?>" name="province" value="<?php if (!empty($profile[0]->ai_state)) {
															echo @$profile[0]->ai_state;
														} ?>">
													</div>
												</div>
												<div class="col-md-6 go-right">
												...
												<div class="col-md-6 go-left">
													<div class="form-group">
														...
														<input id="card-holder-postalcode" class="form-control form" type="text" placeholder="<?php echo trans('0104'); ?>" name="postalcode" value="<?php if (!empty($profile[0]->ai_postal_code)) {
															echo @$profile[0]->ai_postal_code;
														} ?>">
													</div>
												</div>
												<div class="clearfix"></div>
												...
												<div class="col-md-3 go-right">
													<div class="form-group ">
														...
														<select class="form-control" name="expMonth" id="expiry-month">
															<option value="01"><?php echo trans('0317'); ?>(01)
															</option>
															<option value="02"><?php echo trans('0318'); ?>(02)
															</option>
															<option value="03"><?php echo trans('0319'); ?>(03)
															</option>
															<option value="04"><?php echo trans('0320'); ?>(04)
															</option>
															<option value="05"><?php echo trans('0321'); ?>(05)
															</option>
															<option value="06"><?php echo trans('0322'); ?>(06)
															</option>
															<option value="07"><?php echo trans('0323'); ?>(07)
															</option>
															<option value="08"><?php echo trans('0324'); ?>(08)
															</option>
															<option value="09"><?php echo trans('0325'); ?>(09)
															</option>
															<option value="10"><?php echo trans('0326'); ?>(10)
															</option>
															<option value="11"><?php echo trans('0327'); ?>(11)
															</option>
															<option value="12"><?php echo trans('0328'); ?>(12)
															</option>
														</select>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<p style="padding:10px;">
															<input type="checkbox" name="" id="policy" value="1">
														...
														<div class="form-group">
															...
															<div class="col-md-12">
																<button type="submit" class="btn btn-success btn-lg btn-block paynowbtn" style="font-size:18px" onclick="return expcheck();" name="<?php if (empty($usersession)) {
																	echo "guest";
																} else {
																	echo "logged";
																} ?>"><?php echo trans('0306'); ?></button>
															</div>
															<div class="clearfix"></div>
															<hr>
															<div class="panel-body">
				...
				<div class="col-md-4 go-left">
						...
						<div class="filtertip">
							<div class="padding15">
								<div class="text-center">
									<i class="icon_set_1_icon-87 go-right"></i><span><?php if ($appModule == "hotels") { ?><?php echo trans('0726'); ?><?php } else { ?><?php echo trans('0411'); ?><?php } ?></span>
									<span class="countprice"></span></div>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="hpadding30">
							<div>
								<div class="row">
									...
									<div class="clearfix"></div>
									<div class="size13 grey RTL go-right">
										<i class="fa fa-map-marker RTL"></i> <?php echo $module->mapAddress; ?></div>
									<div class="clearfix"></div>
										...
										<table style="margin-bottom:0px;" class="table table_summary">
											...
											<tr>
												<td class="go-right">
													...
													<br> <?php echo $module->checkin; ?>
												</td>
												<td class="go-left">
													<strong> <?php echo trans('09'); ?></strong>
													<br> <?php echo $module->checkout; ?>
												</td>
											</tr>
											<tr>
												<td>
                  ...
                  <span class="right lred2 bold size30"><strong><span id="displaytotal">
			                  ...
			                  <div class="clearfix"></div>
										...
										<div style="text-align: center;font-size:12px;clear: both">
											...
											<?php if ($module->serviceAmount == 0) { ?><?php echo " & " . trans('0699');
											} ?></div>
									<?php } ?>
									...
									<?php if ($appModule == "tours") { ?>
										<table class="table table_summary">
											...
											<tr>
												<td>
													...
													: <?php echo $module->tourDays; ?>
												</td>
												<td class="text-right">
													<strong> <?php echo trans('0122'); ?></strong>
													: <?php echo $module->tourNights; ?>
												</td>
											</tr>
											<tr>
												<td>
											...
											<tr>
												<td>
													<strong> <?php echo trans('010'); ?> (<?php echo $module->adults; ?>
														)</strong>
												</td>
												<td class="text-right">
											...
											<?php if ($module->children > 0) { ?>
												<tr>
													<td>
														<strong> <?php echo trans('011'); ?>
															(<?php echo $module->children; ?>)</strong>
													</td>
													<td class="text-right">
											...
											<?php if ($module->infants > 0) { ?>
												<tr>
													<td>
														<strong> <?php echo trans('0282'); ?>
															(<?php echo $module->infants; ?>)</strong>
													</td>
													<td class="text-right">
											...
											<tr class="beforeExtraspanel">
												...
												<td class="text-right">
													<?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?>
													<span id="displaytax"><?php echo $module->taxAmount; ?></span>
												</td>
											</tr>
											<div class="booking-deposit">
												<tr>
													...
													<td class="text-right">
														<strong><span class="booking-deposit-font go-left"><?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?>
																<span id="displaydeposit"><?php echo $module->depositAmount ?></span></span></strong>
													</td>
												</tr>
											</div>
											<tr class="total">
										...
										<div class="padding30" style="padding-top:0px">
											...
											<span class="right lred2 bold size18">                         <?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?>
												<span id="displaytotal"><?php echo $module->price; ?></span></span>
											<div class="clearfix"></div>
										</div>
                  ...
                  <?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?>
									...
									<table class="table table_summary">
										...
										<tr>
											<td>
												<strong> <?php echo trans('016'); ?></strong>
												: <?php echo $roomsCount; ?>
											</td>
											<td class="text-right">
												...
												: <?php echo $adultCount; ?>
												<?php if ($childCount > 0) { ?>
													<strong> <?php echo trans('011'); ?></strong> : <?php echo $childCount; ?>
													<strong> Age(s): </strong> <?php if (is_array($childAges)) {
														echo implode(',', $childAges);
													} else {
														echo $childAges;
													}
												} ?>
										...
										<?php if (!empty($pricesNightByNight)) {
											foreach ($pricesNightByNight as $key => $val) { ?>
												<tr>
													<td>
														<?php echo $key; ?>
													</td>
                  ...
                  <div class="clearfix"></div>
							...
							<div class="row">
								...
								<?php if (!empty($phone)) { ?>
									<div class="panel-body">
										<h4 class="opensans purple text-center">
											<i class="icon_set_1_icon-57"></i><?php echo trans('061'); ?></h4>
										...
										<p class="opensans size30 purple xslim text-center" style="margin-bottom: 0;">09
											6868 0106</p>
