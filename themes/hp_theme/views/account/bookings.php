...
<div class="row">
  <div class="col-md-5 offset-0">
    ...
    <a class="dark" href="#"><b><?php echo character_limiter($b->title,28); ?></b></a> <br>
  ...
  <div class="col-md-2">
    <h5><strong>
      ...
      <span class="alert alert-success"><?php echo trans('081');?></span>
      <?php }elseif($b->status == "cancelled"){ ?>
      <span class="alert alert-warning"><?php echo trans('0347'); ?></span>
      <?php }elseif($b->status == "reserved"){ ?>
      <span class="alert alert-warning"><?php echo trans('0445');?></span>
      <?php }else{ ?>
      <span class="alert alert-danger"><?php echo trans('082');?></span>
      <?php } ?></strong>
    </h5>
  </div>
  <div class="col-md-2 offset-0">
   ...
   <div class="clearfix"></div> <?php if($b->status == "paid"){ ?> <span class="btn btn-primary btn-block" data-toggle="modal" href="#AddReview<?php echo $b->id;?>" class="btn_3"><?php if($b->reviewsData['reviewGiven'] == "yes"){ echo trans("0391"); }else{ echo trans('083');  } ?> </span> <?php } ?>
  </div>
