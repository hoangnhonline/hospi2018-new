      ...
      <div class="acc_section">
        <div class="col-md-8 offset-0 go-right" style="margin-bottom:50px;">
          ...
          <div class="">
            ...
            <?php if($appModule == "tours"){ ?>
            <div class="panel panel-default">
              <div class="panel-heading no-padding"><div class="hospi-heading"><?php echo trans('0521');?></div></div></div>
              <div class="panel-body">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="" name="passport[<?php echo $i;?>][name]" class="form-control" placeholder="<?php echo trans('0350');?>"/>
                    </div>
                    <div class="col-md-5">
                      <input type="" name="passport[<?php echo $i;?>][passportnumber]" class="form-control" placeholder="<?php echo trans('0523');?>"/>
                    </div>
                    <div class="col-md-2">
                      <input type="" name="passport[<?php echo $i;?>][age]" class="form-control" placeholder="<?php echo trans('0524');?>"/>
                    </div>
                  </div>
                  <hr>
                  <?php } ?>
        ...
        <div class="pagecontainer2 paymentbox">
          ...
          <div class="hpadding30">
            ...
            <img class="img-responsive" src="<?php echo $module->thumbnail;?>" alt="<?php echo $module->title;?>" />
                  ...
                  <div class="lower-case purple"><?php echo $module->tourDays;?> <?php echo trans('0275');?> <?php echo $module->tourNights;?> <?php echo trans('0122');?></div>
            </div>
              <div class="row">
                ...
                <table class="table table_summary">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <?php echo $module->transportation;?>
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong> <?php echo trans('010');?> x <?php echo $module->adults;?></strong>
                      </td>
                      <td class="text-right">
                        <?php echo $module->adultprice;?> <?php echo $module->currSymbol;?>
                      </td>
                    </tr>
                    <?php if($module->children > 0) { ?>
                    <tr>
                      <td>
                        <strong> <?php echo trans('011');?><?php echo trans('0787');?> x <?php echo $module->children;?></strong>
                      </td>
                      <td class="text-right">
                        <?php echo $module->childprice;?> <?php echo $module->currSymbol;?>
                      </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                      <td>
                        <strong> <?php echo trans('0282');?><?php echo trans('0788');?> x <?php echo $module->infants;?></strong>
                      </td>
                      <td class="text-right">
                        <?php echo $module->infantprice;?> <?php echo $module->currSymbol;?>
                      </td>
                    </tr>
                    <?php } ?>
                    <!--<tr>
                      ...
                      <td class="text-right">
                        <?php echo $module->subTotal;?> <?php echo $module->currSymbol;?>
                      </td>
                    </tr>-->
                ...
                <div class="padding30" style="padding-top:0px">
                  ...
                  <span class="right lred2 bold size18">                         <span id="displaytotal"><?php echo $module->price;?></span> <?php echo $module->currSymbol;?></span>
                  <div class="clearfix"></div>
                </div>
