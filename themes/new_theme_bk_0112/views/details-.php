      ...
      <div>
        <div class="col-md-9 go-right">
          <div style="margin-top: 6px">
            <h1 class="go-right" style="font-size: 16px;margin-top: 10px;margin-bottom: 0px;"> <strong><?php echo $module->title;?></h1> </strong> <small class="go-right"><?php echo $module->stars;?></small> <span class="pull-right go-left"><?php if($hasRooms){ ?><?php //echo trans('0141');?><?php } ?> </span>
