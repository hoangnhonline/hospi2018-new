...
<div class="offer-banner-bottom">
    ...
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="khuyen-mai"><a class="" href="<?php echo base_url();?>bestchoice"><?php echo trans('0558'); ?></a></span></div>
    <div class="col-xs-12 col-sm-3 col-lg-3"><span class="bestchoice"><a class="" href="<?php echo base_url();?>combo"><?php echo trans('0559'); ?></a></span></div>
