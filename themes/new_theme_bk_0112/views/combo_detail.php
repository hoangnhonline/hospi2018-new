...
<div class="container offer-banners">
  <div id="carousel-banner" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item"><img alt="" src="https://www.hospi.vn/uploads/cms/images/1513311094_Six-senses-Con-Dao-Resort.png"></div><div class="item active"><img alt="" height="323" src="https://www.hospi.vn/uploads/cms/images/1513206591_Sapa-jade-hill.png" width="1140"></div><div class="item"><img alt="" height="323" src="https://www.hospi.vn/uploads/cms/images/1514540448_Combo-ictoria-Núi-Sam-Châu-Đốc.jpg" width="1140"></div><div class="item"><img alt="" height="323" src="https://www.hospi.vn/uploads/cms/images/1513215826_Sea-Shell-phu-quoc-hotel-&amp;-Spa.png" width="1140"></div>        </div>
        <!-- Indicators -->
        <ol class="carousel-indicators hidden-xs">
                        <li data-target="#carousel-banner" data-slide-to="0" class=""></li><li data-target="#carousel-banner" data-slide-to="1" class="active"></li><li data-target="#carousel-banner" data-slide-to="2" class=""></li><li data-target="#carousel-banner" data-slide-to="3" class=""></li>        </ol>
    </div>
     ...
     <div class="visible-xs col-xs-12 offer-content-menu-promotion no-padding-mobile text-center">
       <ul class="">
          ...
          <li><a href="<?php echo base_url();?>bestchoice">Bestchoice</a></li>
          <li class="active"><a href="<?php echo base_url();?>combo">Combo</a></li>
      </ul>
    </div>
</div>
             ...
             <i class="fa fa-star cl-tim" aria-hidden="true"></i> -->
                        ...
                        <div class="block-tabs-2">
                            ...
                            <ul class="nav nav-tabs nav-tabs-honemoon-details-desktop nav-tabs-honemoon-details-mobile" role="tablist">
                                ...
                                <li role="presentation" class=""><a href="#Rule_cancel" aria-controls="Rule_cancel" role="tab" data-toggle="tab">Điều kiện</a></li>
                            </ul>
                            <!-- Tab panes -->
                            ...
                            <div class="block-content">
                                <div class="block-cb-detail">
                                    ...
                                    <div class="detail">
                                        ...
                                        <button type="button" class="btn btn-combo2" data-toggle="modal" data-target="#book-combo"><?php echo  'Đặt combo' ; ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form action="<?php echo base_url() . $appModule;?>/book/<?php echo $module->slug; ?>" method="get" role="search">
                        ...
                        <div class="form-inline row">
                            <div class="col-sm-6 col-xs-6" >
                                <div class="form-group cls-poup "  style= "width: 100%">
                                    <div class="row" >
                                        <div class="col-sm-12">
                                            <p class=""> Giá trọn gói</p>
                                        </div>
                                        <div class="col-sm-12" style = "padding-right: 0px;">
                                            <p class="price-sm" style= "width: 100%"><strong><?php echo $module->price; ?> <?php echo $module->currSymbol; ?></strong></p>
                                        </div>
                                    </div>    
                                </div>
                            </div>    
                            <div class="form-group cls-right-poup col-sm-6 col-xs-6">
