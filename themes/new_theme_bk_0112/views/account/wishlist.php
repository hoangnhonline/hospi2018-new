<div class="panel-body">
  ...
  <div class="col-md-2 offset-0">
    <a class="form-group" href="<?php echo base_url().$wl->slug;?>" target="_blank"><span class="btn btn-sm btn-action btn-block">  <?php echo trans('0109');?></span></a>
    <div class="clearfix"></div>
    <div style="margin:5px"></div>
    <div class="clearfix"></div>
    <span class="btn btn-sm btn-block btn-danger removewish" id="<?php echo $wl->wishid;?>">  <?php echo trans('0108');?></span>
  </div>
  <div class="clearfix"></div>
  <div class="line2"></div>
  </div>
