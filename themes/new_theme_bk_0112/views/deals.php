        ...
        <div class="itemscontainer offset-1">
            ...
            if (!empty($module)) {
                ...
                foreach ($module as $item) {
                    if ($line == 8) echo "<div class='block-news-addon clearfix'><div class='row'><div class='col-sm-6 col-xs-12'><ul class='offset-2 offer-page'>";
                    if ($line == 11) { echo "</ul></div><div class='col-sm-6 col-xs-12'>"; echo run_widget(83);echo "</div>";echo "</div></div>";}
                    if ($line < 8 || $line > 10) {
                        ?>
                        <div class="col-sm-3 col-xs-12 no-padding-mobile" style="margin-bottom: 30px">
                                ...
                                <div class="itemlabel3">
                                    <div class="labelleft2 rtl_title_home">
                                        <h4 class="mtb0 RTL go-text-right offer-title-listing">
                                            <a href="<?php echo $item->slug;?>" style="font-size: 18px; line-height: 20px;font-family: 'AndesRounded';">
                        ...
                        <li style="margin-top: 15px;">
                            <a class="sub-menu-link" href="<?php echo $item->slug; ?>" target="_blank">
                                <h4 style="margin-top: 10px;" class="offer-3title offer-title-listing"><b><?php echo $item->title; ?></b></h4>
