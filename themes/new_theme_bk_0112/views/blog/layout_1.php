...
?>
<div class="listinews">
    <div class="newshot news-style news-style-blue style-<?php echo $class1;?>">
        ...
        <div class="info">
            ...
            <p class="RTL hidden-xs"><?php echo character_limiter(strip_tags($first->post_desc), 200); ?></p>
        ...
        <div class="list-news">
            <ul>
                ...
                foreach ($posts as $post) {
                    ?>
                    <li class="news-style news-style-blue news-style-list clearfix style-<?php echo $class1;?>">
                        <div class="image">
                        ...
                        <div class="info">
                            ...
                            <div>
                                <p class="RTL hidden-xs"><?php echo character_limiter(strip_tags($post->post_desc), 200); ?></p>
                                <div class="post-left go-right">
                                    <ul class="go-right">
