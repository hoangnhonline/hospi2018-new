...
class Xcrud_config
{
    ...
    public static $images_in_grid_height = 20; // maximal height of thumbnails in list view
    ...
    public static $set_as_checkboxes = true; // shows SET field as checkboxes, multiselect by default
    ...
    public static $enable_table_title = false; // show table title and toggle button
    ...
    // alert settings
    public static $email_from = 'info@domain.com'; // email from address
    public static $email_from_name = 'PHPTRAVELS'; // email from name
    ...
    public static $xss_disalowed_attibutes = array('on\w*', /*'style',*/
        'xmlns', 'formaction'); // Remove bad attributes such as style, onclick and xmlns
