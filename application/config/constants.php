...
define('HOTEL_THUMB_WIDTH', 210);
define('HOTEL_THUMB_HEIGHT', 150);
define('HOTEL_MEDIUM_WIDTH', 625);
define('HOTEL_MEDIUM_HEIGHT', 425);
define('PT_RIGHTS', 'HOSPI');
define('PT_VERSION', 'v5.3');
define('PT_LINK', 'http://hospi.vn');
define('PT_SHOW', '1');
define('PT_STARS_ICON', "<i class='star text-warning fa fa-star voted'></i>");
define('PT_EMPTY_STARS_ICON', "<i class='star text-warning fa fa-star-o'></i>");
...
/*** Location Images ***/
define('PT_LOCATION_IMAGES', PT_BASE_URL . 'uploads/images/location/');
define('PT_LOCATION_IMAGES_THUMBS', PT_BASE_URL . 'uploads/images/location/thumbs/');
define('PT_LOCATION_IMAGES_UPLOAD', 'uploads/images/location/');
define('PT_LOCATION_IMAGES_UPLOAD_THUMBS', 'uploads/images/location/thumbs/');
/*** End Location Images ***/
...
define('PT_BLOG_THUMBS', PT_BASE_URL . 'uploads/images/blog/thumbs/');
define('PT_BLOG_THUMBS_UPLOAD', 'uploads/images/blog/thumbs/');
define('PT_BLOG_MEDIUM', PT_BASE_URL . 'uploads/images/blog/mediums/');
define('PT_BLOG_MEDIUM_UPLOAD', 'uploads/images/blog/mediums/');
/*** End  Blog Images ***/
...
define("ACTION_MESSAGE", "acction_message");
define("ERROR", "error");
