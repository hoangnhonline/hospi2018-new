          ...
          <?php endforeach; } ?>
              ...
              <div class="form-group ">
                ...
                <?php } ?>
                  ...
                  <span class="help-block">Chỉ dùng cho trường hợp hiển thị tìm kiếm tour. Bài này sẽ được dùng như là 'Cẩm nang du lịch' trong kết quả tìm kiếm tour tương ứng với 'Related Location' được chọn</span>
              </div>
            </div> 
            ...
            <div class="col-md-6">
              ...
              <div class="form-group ">
                ...
                <select data-placeholder="Select" name="featured" class="form-control" tabindex="2">
                      ...
                      <span class="help-block">Dùng cho Blog's sidebar "Bạn đang quan tâm"</span>
              </div>
            </div>    
