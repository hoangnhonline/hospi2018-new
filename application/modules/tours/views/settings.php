...
<h3 class="margin-top-0">Tours Settings</h3>
<form action="" method="POST">
  <div class="panel panel-default">
    <ul class="nav nav-tabs nav-justified" role="tablist">
      <li class="active" id="Generaltab"><a href="#GENERAL" data-toggle="tab">General</a></li>
      <li class=""><a href="#TOURTYPES" data-toggle="tab">Types</a></li>
      ...
      <div class="tab-content form-horizontal">
        ...
        <div class="tab-pane wow fadeIn animated in" id="TOURTYPES">
          <div class="add_button_modal">
            <button type="button" data-toggle="modal" data-target="#ADD_TOURS_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button>
          </div>
          <div class="clearfix"></div>
    ...
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body form-horizontal">
          ...
          <?php foreach($languages as $lang => $val){ if($lang != "vi"){ @$trans = getTypesTranslation($lang, $ts->sett_id); ?>
          <div class="row form-group">
            <label  class="col-md-3 control-label text-left"> Name in <img src="<?php echo PT_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" />&nbsp;<?php echo $val['name'];?></label>
            <div class="col-md-8">
