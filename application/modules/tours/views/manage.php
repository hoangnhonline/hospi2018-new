    ...
    <div class="panel-body">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Tour Code</label>
            <div class="col-md-4">
              <input class="form-control" type="text" placeholder="Tour Code" name="tourcode" value="<?php echo $tdata[0]->tour_code;?>" >
            </div>
          </div>
          <div class="row form-group">
          ...
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Departure Date</label>
            <div class="col-md-4">
              <input class="form-control" type="text" placeholder="Departure Date" name="departure" value="<?php echo $tdata[0]->tour_departure;?>" >
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Transportation by</label>
            <div class="col-md-4">
              <input class="form-control" type="text" placeholder="Transportation by" name="transportation" value="<?php echo $tdata[0]->tour_transportation;?>" >
            </div>
          </div>
          <div class="row form-group">
        ...
        <div class="tab-pane wow fadeIn animated in" id="INCLUSIONS">
          <div class="row form-group">
            <div class="col-md-12">
            <label class="col-md-2 control-label text-left">Inclusions</label>
            <div class="col-md-8">
              <textarea class="form-control" placeholder="Inclusions..." name="include" rows="3"><?php echo $tdata[0]->include;?> </textarea>
            </div>
              <!--<div class="col-md-4">
        ...
        <div class="tab-pane wow fadeIn animated in" id="EXCLUSIONS">
          <div class="row form-group">
            <div class="col-md-12">
                <label class="col-md-2 control-label text-left">Exclusions</label>
            <div class="col-md-8">
              <textarea class="form-control" placeholder="Exclusions..." name="exclude" rows="3"><?php echo $tdata[0]->exclude;?> </textarea>
            </div>
              <!--<div class="col-md-4">
                <label class="pointer"><input class="all" type="checkbox" name="" value="" id="select_all" > Select All</label>
              </div>
        ...
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          ...
          <div class="row form-group">
            ...
            <div class="row form-group">
            <label class="col-md-2 control-label text-left">Tour Operator</label>
            <div class="col-md-6">
              <input name="touroperator" type="text" placeholder="Tour Operator" class="form-control" value="<?php echo @$tdata[0]->tour_operator;?>" />
            </div>
          </div>
        </div>
