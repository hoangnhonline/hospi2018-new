			...
			if(empty($user)){
				...
				$data = array('tour_title' => $this->input->post('tourname'), 
					...
					'tour_type' => $this->input->post('tourtype'),
                                        'tour_departure' => $this->input->post('departure'),
                                        'include' => $this->input->post('include'),
                                        'tour_code' => $this->input->post('tourcode'),
                                        'exclude' => $this->input->post('exclude'),
                                        'tour_transportation' => $this->input->post('transportation'),
					...
					'tour_fulladdress' => $this->input->post('tourfulladdress'),
                                        'tour_operator' => $this->input->post('touroperator'),
