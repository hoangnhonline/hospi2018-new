...
class Home extends MX_Controller
{
    ...
    function __construct()
    {
        ...
        $this->data['tel'] = $this->load->get_var('tal');
        $this->data['fax'] = $this->load->get_var('fax');
    ...
    public function index()
    {
        ...
        $city = $this->input->post('city'); // lay city tu dropdown box khuyen mai
        ...
        if ($pageslug == null || $this->validlang && empty($secondslug)) {
            ...
            $this->data['page_menu'] = @$content[0]->page_menu;
        ...
        //$end = $this->microtime_float() - $start;
        //printf("%0.3f seconds\r\n", $end);
    }
...
//subscribe to newsletter
    ...
    function ajax_getSaleoffHotels()
    {
