 ...
 <?php if($this->session->flashdata('flashmsgs')){ echo NOTIFY; } ?>
  <div class="panel panel-primary">
    <div class="panel-heading">
      <span class="panel-title pull-left"><i class="fa fa-list-alt"></i> Translate Hotel " <strong> <?php   echo $transtitle; ?></strong> "</span>
    ...
    <div class="tabbable tabs-left">
      <ul class="nav nav-tabs" style="height:850px;background-color:#F2F2F2;margin-top:5px;margin-bottom:0px">
        ...
        <li class="<?php if($ldir == $lang){ echo "active"; } ?>"><a href="<?php echo base_url().$adminsegment."/hotels/translate/".$slug."/".$ldir;?>"><img src="<?php echo PT_LANGUAGE_IMAGES.$ldir.".png";?>" style="width:30px;height:25px" alt="" /> <?php echo $lname; ?></a></li>
        <?php } } ?>
      </ul>
      ...
      <form action="" method="POST">
        <div class="tab-pane fade active in" id="english">
          <div class="panel-body" style="margin-left:150px;padding-bottom:0px">
            ...
            <div class="panel panel-primary">
              <div class="panel-heading"><strong>Additional Facilities</strong></div>
              <div style="margin-bottom: 0px;">
                <textarea class="form-control" placeholder="Additional Facilities" name="additional" rows="4" name=""> <?php  echo $transadditional; ?></textarea>
              </div>
            </div>
            <div class="panel panel-primary">
              <div class="panel-heading"><strong>Privacy And Refund Policy</strong></div>
              <div  style="margin-bottom: 0px;">
                <textarea class="form-control" placeholder="Privacy And Refund Policy" rows="4" name="policy"><?php  echo $transpolicy; ?></textarea>
              </div>
            </div>
