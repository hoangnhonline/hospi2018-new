          ...
          <div class="well">
            <form class="form-horizontal reviews-form" method="POST" action="" >
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-md-5 control-label">Food</label>
                <div class="col-md-5">
                  <select class="form-control reviewscore" name="reviews_staff">
                    <?php
                      for($anuong = 1;$anuong < 11;$anuong++){
                      ?>
                    <option value="<?php echo $anuong;?>" <?php if($anuong == $details[0]->review_anuong){echo "selected";}?>  ><?php echo $anuong; ?></option>
                    <?php
                      }
