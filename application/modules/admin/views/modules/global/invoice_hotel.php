...
<html ng-app="phptravelsApp">
    ...
    <head>
        ...
        <meta property="og:title" content="<?php echo $invoice->title; ?>"/>
    ...
    <body id="top">
                ...
                <div class="navbar">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="navbar-header go-right logo-mobile ">
                            <a href="https://www.hospi.vn" class="navbar-brand"><img class="cs-invoiceHotel-img1" style="margin:0 auto;" src="<?php echo $theme_url; ?>assets/img/logo.png" alt="HOSPI - Đặt phòng khách sạn" class="logo"/></a>
                        </div>
                    </div>
                    <div class="col-md-10 col-xs-12">
                        ...
                        <div class="col-md-4 margin-top-15 col-xs-12">
                            <div class="text-center clss-img-combo">
                                <img class="cs-invoiceHotel-img2" src="<?php echo $theme_url; ?>asset/img/invoice_hotel.png" class="img-responsive"/>
                            </div>
                                    ...
                                    <div id="phuongthucthanhtoan" class="tab-pane fade">
                                        ...
                                        <div class="col-lg-12 col-xs-12 conten-visa-card no-padding" id="show-atm-select" style="display: none">
                                            <div class="col-lg-12 col-xs-12 content-visa-item no-padding">
                                                ...
                                                <div class="col-lg-12 col-xs-12">
                                                    <span>Chi nhánh: Bến Thành,Tp Hồ Chí Minh</span>
                                                </div>
                                    ...
                                    <div class="hidden-xs">
                                        ...
                                        <div class="tab-content">
                                            <div id="phuongthucthanhtoan" class="tab-pane fade in active">
                                                ...
                                                <div class="content-visa-item bank_6" style="display: none">
                                                    <div class="row">
                                                        <div class="col-sm-4 col-xs-12"></div>
                                                        <div class="col-sm-8 col-xs-12">
                                ...
                                <div class="tab-content">
                                    <div id="donphongcuaban" class="tab-pane fade in active">
                                        <div class="col-lg-12 col-xs-12 no-padding">
                                            ...
                                            <div class="clearfix block-info-time-book block-info-time-book-no-padding">
                                                <div class="info-time-book">
                                                    <div>
                                                        <span class="cl-black text-bold">Ngày nhận phòng</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->checkin; ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold">Ngày trả phòng</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->checkout; ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold">Số đêm</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $nights; ?></span>
                                                    </div>
                                                </div>
                                                <div class="info-people">
                                                    <div>
                                                        <span class="cl-black text-bold">Người lớn</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->adult; ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold">Trẻ em</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->child; ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold" style="white-space: nowrap;">Số lượng </span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $bookedList->booked_room_count; ?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold">Giường phụ</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $bookedList->booked_extra_bed; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xs-12 no-padding clss-content-book margin-top-30" style="padding-top: 10px;padding-bottom: 10px">
                                            <div>
                                                <span class="cl-grey">Yêu cầu giường</span><span class="cl-tim" style="font-weight: bold;">:   <?php echo $invoice->booking_extra_beds_request;?> giường</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xs-12 no-padding clss-content-book margin-top-30" style="padding-top: 10px;padding-bottom: 10px">                                            
                                            <div class="cl-tim">
                                                <?php if($bookedList->price_type){ ?>
                                                <span style="font-weight: bold;"><?php echo $bookedList->price_type; ?></span><br>
                                                <?php } ?>
                                                <span style="font-weight: bold;"><?php echo $bookInfo[$bookedList->booked_room_id]->title; ?></span>
                                            </div>
                                            <div class="cl-grey font-size-mobile-12">
                                                <span> <?php echo number_format($bookedList->price); ?> x <?php echo $nights; ?>
                                                (đêm) x <?php echo $bookedList->booked_room_count; ?>
                                                (phòng) = <?php echo number_format($bookedList->price * $bookedList->booked_room_count * $nights); ?>
                                                VND</span>
                                            </div>
                                            <?php if($bookedList->booked_extra_bed > 0){ ?>
                                            <div class="cl-tim">
                                                <span style="font-weight: bold;">* Giường phụ : <?php echo $bookedList->booked_extra_bed; ?> giường</span>
                                            </div>
                                            <div class="cl-grey font-size-mobile-12">
                                                <span><?php echo number_format($bookedList->bed_price); ?> x <?php echo $nights; ?>
                                                (đêm) x <?php echo $bookedList->booked_extra_bed; ?>
                                                (giường) = <?php echo number_format($bookedList->bed_price*$nights*$bookedList->booked_extra_bed); ?>
                                                VND</span>
                                            </div>
                                           <?php } ?>
                                        ...
                                        <div class="col-lg-12 col-xs-12 content-item-text no-padding" style="padding-top: 10px;padding-bottom: 10px">
                                            <div class="col-lg-12 col-xs-12 cl-grey no-padding">
                                                ...
                                                <div class="col-lg-6 col-xs-6 text-right">
                                                    <span><?php echo number_format($bookedList->bed_price*$nights*$bookedList->booked_extra_bed + $bookedList->price * $bookedList->booked_room_count * $nights); ?> VND</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-xs-12 cl-grey no-padding">
                                            ...
                                            <div class="col-lg-12 col-xs-12 no-padding cl-grey">
                                                ...
                                                <div class="col-lg-6 col-xs-6 text-right">
                                                    <span><b><?php echo number_format($bookedList->bed_price*$nights*$bookedList->booked_extra_bed + $bookedList->price * $bookedList->booked_room_count * $nights); ?>
                                                    VND</b></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xs-12 content-giam-gia no-padding padding-top-10">
                                            ...
                                            <div class="col-lg-12 col-xs-12 no-padding cl-tim clss-tongthanhtoan">
                                                <div class="col-lg-6 col-xs-6 text-left "><span>Còn lại </span></div>
                                                <div class="col-lg-6 col-xs-6 text-right">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('.bank_<?php echo $bookedList->bank_id;?>').show();
            });
        </script>
    </body>
</html>