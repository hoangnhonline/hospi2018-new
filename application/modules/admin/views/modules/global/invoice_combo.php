                                            ...
                                            <div class="clearfix block-info-time-book block-info-time-book-no-padding">
                                                <div class="info-time-book">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold">
                                                            <?php 
                                                            $tmp = explode('/', $invoice->checkin);
                                                            $dateTmp = date('Y-m-d', strtotime($tmp['2']."-".$tmp['1'].'-'.$tmp[0]));
                                                            echo date('d/m/Y',strtotime($dateTmp.' +'.$invoice->nights.' days')); 
                                                            ?>
                                                        </span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->nights;?></span>
                                                    </div>
                                                    <?php }else{?>
                                                    <div>
                                                        <span class="cl-black text-bold">Ngày nhận phòng</span>
                                                    ...
                                                    <div>
                                                        <span class="cl-black text-bold">Ngày trả phòng</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"></span>
                                                    </div>
                                                    <?php }?>
                                                </div>
                                                <div class="info-people">    
                                                    ...
                                                    <div>
                                                        <span class="cl-black text-bold">Số lượng</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->booking_quantity;?></span>
                                                    </div>
                                                    <div>
                                                        <span class="cl-black text-bold">Giường phụ</span>
                                                        <span>:</span>
                                                        <span class="cl-tim cl-bold"><?php echo $invoice->extraBeds;?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <?php $subTotal =  $invoice->offer_detail->offer_price *$invoice->booking_quantity; ?>
                                        <div class="col-lg-12 col-xs-12 no-padding clss-content-book margin-top-15">
                                            <div class="col-lg-12 col-xs-12 cl-tim">
                                                <span><?php echo $invoice->offer_detail->offer_title; ?></span>
                                            </div>
                                            <div class="col-lg-12 col-xs-12 font-size-mobile-12">
