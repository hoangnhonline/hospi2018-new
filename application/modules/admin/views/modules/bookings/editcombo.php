	...
	<div class="container" id="content">
		...
		<div class="panel panel-default col-md-7" id="div_form_booking">
			<ul class="nav nav-tabs nav-justified" role="tablist">
				<li class="active">
					<a href="#GENERAL" class="text-left" data-toggle="tab" aria-expanded="true">Chỉnh sửa Booking</a></li>
				...
				<div class="tab-content ">
					<div class="tab-pane wow fadeIn animated active" id="GENERAL">
												...
												<div class="col-md-7">
													<div class="form-group">
														<label for="select-standard" class="control-label col-md-4 font-weight-unset">Tạo
															mã combo</label>
														<div class="col-md-8">
															<input readonly="readonly" type="text" name="combo_code" id="txt_combo_code" class="form-control" value="<?php echo $model['combo_code']?>">
														</div>
													</div>
												</div>
                        ...
                        <div id="chargeList">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="username0" class=" control-label font-weight-unset">Số
																	lượng</label>
																<input onkeyup ="loadPrice()" type="text" class="form-control" value="<?php echo $model['basecharge_quantity'] ?>" name="basecharge_quantity">
															</div>
														</div>
														<div class="clearfix"></div>
														...
														foreach ($model['surcharge_list'] as $key => $surcharge) {
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="username0" class=" control-label font-weight-unset">Số
																		lượng</label>
																	<input onkeyup ="loadPrice()" type="text" class="form-control" value="<?php echo $surcharge['quantity'] ?>" name="surcharge_list[<?php echo $i; ?>][quantity]">
												...
												<div class="col-md-6" style="margin-left: 15px;    margin-top: 33px;">
													<div class="form-group">
														...
														<div class="icheckbox_square-grey " style="position: relative;">
															<input  id="unknown_date" type="checkbox" class="form-control checkboxcls" <?php if($model['is_unknown_date']==1) echo  'checked=\"checked\"' ?> name="is_unknown_date">
														</div>
														Mua trước trả sau
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class=" control-label font-weight-unset">Chi phí
															khác</label>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body" style="padding-top: 15px">
											...
											<div class="col-md-5">
												<div class="form-group ">
                                                          <label for="select-standard" class="control-label font-weight-unset" ></label>
                                                         <textarea cols="4" rows="8" class="form-control" placeholder="Bạn có yêu cầu khác" name="customer_request">
...
<script type="text/javascript">
    ...
    $("#generate_combo_code").click(function () {
        $.post("<?php echo base_url();?>admin/bookings/generate_combo_code", {}, function (res) {
            $("#txt_combo_code").val(res);
        });
    });

    $("select#location").change(function () {
        url = "<?php echo base_url();?>admin/bookings/listCombo?city_id=" + $(this).val();
        $.ajax({
	...
	if (event.type == 'ifChecked') {
       // $(".chuyenkhoan").iCheck('uncheck');
        //$(this).iCheck('check');
			...
			//	$("#payment_method3") .iCheck('uncheck');
			//	$("#payment_method2") .iCheck('uncheck');
			}
			else{
				if(_val==2)
				{
				...
				//	$("#payment_method3") .iCheck('uncheck');
				//	$("#payment_method1") .iCheck('uncheck');
				}
				else{
					if(_val==3)
					{
