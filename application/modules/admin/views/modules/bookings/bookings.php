          ...
          <tbody role="alert" aria-live="polite" aria-relevant="all">
            ...
            <tr>
              ...
              <td style="width:330px" align="center">
                ...
                <?php } if(1==1){ ?>   <a href="<?php echo base_url().$adminsegment;?>/bookings/edit/<?php echo $book->booking_type;?>/<?php echo $book->booking_id;?>" ><span class="btn btn-xs btn-warning"><i class="fa fa fa-edit"></i> Edit</span> </a><?php } ?>
