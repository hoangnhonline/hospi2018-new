       ...
       <div class="col-md-5">
         ...
         <div class="panel panel-default col-md-7" >
                      <ul class="nav nav-tabs nav-justified" role="tablist">
                          <li class="active "><a href="#GENERAL" class="text-left" data-toggle="tab" aria-expanded="true">Tạo Booking</a></li>
...
<!--                                               <form role="form" class="form-horizontal">
 -->                                                <div class="col-md-7">
                                                       <div class="form-group">
                                                         ...
                                                         <div class="col-md-6">
                                                           <input type="text" name="hotel_code" id="txt_hotel_code" class="form-control">
                                                         </div>
 ...
 -->                                              <div class="col-md-7">
                                                ...
                                                <div class="col-md-5">
                                                  <div class="form-group ">
                                                         ...
                                                         <textarea cols="4" rows="8" class="form-control" placeholder="Bạn có yêu cầu khác"><?php echo $model['customer_request']?></textarea>
                        ...
                        <div class="panel-body" style="padding-top: 0px;padding-left:0px;padding-right:0px">
                            ...
                            <form role="form">
                              ...
                              <div class="col-lg-12 col-xs-12 conten-visa-card" id="showatm" style="display: none">
                                <div class="col-lg-12 col-xs-12 content-visa-item no-padding bank_info" id="vcb" style="display: none" style="border: 1px solid #ccc;">
                                ...
                                <div class="col-lg-12 col-xs-12 content-visa-item no-padding bank_info" id="acb" style="display: none" style="border: 1px solid #ccc;">
                                ...
                                <div class="col-lg-12 col-xs-12"><span>Số tài khỏa: 227041599</span></div>
                                 ...
                                 <div class="col-lg-12 col-xs-12 content-visa-item no-padding bank_info" id="donga" style="display: none" style="border: 1px solid #ccc;">
                                ...
                                <div class="col-lg-12 col-xs-12"><span>Số tài khỏa: 0103812000</span></div>
                                 ...
                                 <div class="col-lg-12 col-xs-12 content-visa-item no-padding bank_info" id="mb" style="display: none" style="border: 1px solid #ccc;">
