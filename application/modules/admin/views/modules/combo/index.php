   ...
   <div class="panel-body" style="padding-top:5px;">
   	<div class="panel panel-default" style="margin-bottom:5px !important">
        ...
        <div class="panel-body">
          <form class="form-inline" id="searchForm" role="form" method="GET" action="<?php echo base_url() .'admin/combo'; ?>">
            ...
            <div class="form-group">              
              <input type="text" class="form-control" placeholder="Tên combo" name="offer_title" value="<?php echo isset($params['offer_title']) ? $params['offer_title'] : ""; ?>">
            </div>                                     
...
echo '<input class="form-control input-sm" data-url='.$url.' type="number" id="order_'.$item->offer_id.'" value='.$item->offer_order.' min="1"  onblur="updateOrder($(this).val(),'.$item->offer_id.','.$item->offer_order.')" />';
                ...
                <td style="white-space:nowrap; text-align:right">                                 
                  <a href="<?php echo base_url() . 'admin/combo/manage/'.$item->offer_slug; ?>" class="btn btn-warning btn-sm" target="_self"><i class="fa fa-edit"></i></a>                  
