<div class="container" id="content">
  ...
  <div class="panel-heading">Quản lý đăng ký khách hàng</div>
  <div class="clearfix"></div>
   ...
   <div class="panel-body" style="padding-top:5px;">
     ...
     <div class="box">    
     <a href="<?php echo  base_url() . 'admin/customer/add' ; ?>" style="background: #660033;margin-left: 15px;margin-top: 15px;" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> Đăng Ký Khách Hàng</a>   
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <tbody>
                ...
                foreach ($content as $key => $value) {
                  $i++;
                  $editLink =  base_url() . 'admin/customer/edit?id='.$value->accounts_id;
