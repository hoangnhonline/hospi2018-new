            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                     ...
                     <div class="form-group">
                    <label for="form-input" class="col-sm-1 control-label">Icon</label>
                    <div class="col-sm-4">
                <input class="form-control" type="text" placeholder="Page Icon" name="page_icon" value="<?php echo  @$pagedata[0]->page_icon;?>">
                    ...
                    <div class="form-group">
                    <label for="form-input" class="col-sm-1 control-label">Sidebar Menu</label>
                    
                        <div class="col-sm-4">
                          <select type="text" name="page_menu" class="form-control" id="dbase" placeholder="Search">
                            <option value="">Select menu</option>
                            <?php foreach($menus as $m){ ?>
                            <option value="<?php echo $m->menu_id;?>" <?php if($pagedata[0]->page_menu == $m->menu_id) { echo "selected"; } ?> ><?php echo $m->menu_title;?></option>
                            <?php } ?>
                          </select>
                          </div>
