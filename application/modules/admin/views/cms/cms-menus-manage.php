  ...
  <nav class="panel-heading navbar navbar-default" role="navigation" style="margin-bottom:0px">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        <a class="navbar-brand">Menu Management</a>
      </div>
      ...
      <div style="margin-right: -26px" class="navbar-form navbar-right" method="POST" action="" role="search">
        <button data-toggle="modal" href="#menu"  class="btn btn-success pull-right"> Create Menu</button>
      </div>
      <div class="navbar-header">
      ...
      <div class="navbar-form navbar-left"  style="padding-right: 6px;">
        <input type="hidden" name="selectmenu" value="1" />
        <button data-toggle="modal" href="#updatemenu<?php echo $menudetail[0]->menu_id;?>" class="btn btn-warning" >Update</button>
      </div>
      <!--</form> -->
      <?php if($menudetail[0]->coltype == "header"){ }else{ ?>
      <form class="navbar-form navbar-left" style="padding-left: 0px;" >
        <span class="btn btn-danger pull-right delmenu" id="<?php echo $menudetail[0]->menu_id;?>">Delete</span>
      </form>
      <?php } ?>
    </div>
  </nav>
      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <nav class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
              <div class="navbar-header">
                <a class="navbar-brand">Custom Menu</a>
              </div>
            </div>
          </nav>
          <form action="" method="POST">
              <ul style="padding:0 5px;">
                  <li style="list-style-type:none;"><label style="width:15%;">URL</label><input type="text" name="customlink" style="width:85%;" /></li>
                  <li style="list-style-type:none;"><label style="width:15%;">Text</label><input type="text" name="customname" style="width:85%;" /></li>
              </ul>
            <input type="hidden" name="addcustommenu" value="1" />
            <input type="hidden" name="menu" value="<?php echo $menudetail[0]->menu_id;?>" />
            <input type="hidden" name="menutype" value="<?php echo $menudetail[0]->coltype;?>" />
            <div class="panel-footer">
              <button type="submit" class="btn btn-primary">Add to Menu</button>
              ...
              <div class="dd" id="nestable">
                <ul class="dd-list">
                  <?php
                    ...
                    $dpname = $this->ptmodules->show_display_name($menutitle);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-horizontal">
            ...
            <?php foreach($languages as $lang => $val){ if($lang != "vi"){ @$trans = getMenusTranslation($lang,$m->menu_id); ?>
            <div class="form-group">
              <label  class="col-md-3 control-label text-left"> Name in <img src="<?php echo PT_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" />&nbsp;<?php echo $val;?></label>
              <div class="col-md-9">
