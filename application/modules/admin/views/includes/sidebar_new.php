...
<style type="text/css">
	...
	.nav-tabs.nav-justified > .active > a.clssnhapthongtin,
	.nav-tabs.nav-justified > .active > a.clssnhapthongtin:hover,
	.nav-tabs.nav-justified > .active > a.clssnhapthongtin:focus {
		padding-left: 0px;
		width: 103px;
		padding-right: 0px;
		border-bottom: 1px solid #660033;
	...
	.nav-tabs.nav-justified > .active > a.clssthongtinhcanhan,
	.nav-tabs.nav-justified > .active > a.clssthongtinhcanhan:hover,
	.nav-tabs.nav-justified > .active > a.clssthongtinhcanhan:focus {
		width: 126px;
		border-bottom: 1px solid #660033;
		padding-left: 0px;
		padding-right: 0px;
	...
	.nav-tabs.nav-justified > .active > a.clsstinhtrangthanhtoan,
	.nav-tabs.nav-justified > .active > a.clsstinhtrangthanhtoan:hover,
	.nav-tabs.nav-justified > .active > a.clsstinhtrangthanhtoan:focus {
		padding-left: 0px;
		width: 154px;
		padding-right: 0px;
		border-bottom: 1px solid #660033;
			...
			<div class="menu-content">
				<ul id="social-sidebar-menu">
					<?php if ($isadmin) { ?>
							...
							if ($isSuperAdmin) { ?>
								<li>
									<a href="<?php echo base_url(); ?>admin/updates"><i class="fa fa-refresh"></i>
										<span>Cập nhật</span><span class="pull-right label label-danger" id="updatescount"><?php if ($chkupdates->count > 0) {
						...
						<li>
							...
							<ul id="<?php echo trans('017'); ?>" class="collapse wow fadeIn animated">
								<?php if ($role != "admin") { ?>
									<li><a href="<?php echo base_url(); ?>admin/user">Quản trị viên</a></li>
								<?php } ?>
								<li><a href="<?php echo base_url(); ?>admin/accounts/suppliers">Đối tác</a></li>
								<li><a href="<?php echo base_url(); ?>admin/customer">Khách hàng</a></li>
							</ul>
						</li>
						<?php if ($isSuperAdmin) { ?>
							<li>
								...
								<ul id="menu-ui" class="collapse wow fadeIn animated">
									...
									<li>
										<a href="<?php echo base_url(); ?>admin/settings/paymentgateways">Quản lý thanh
											toán</a>
									</li>
									<li>
									...
									<li>
										<a href="<?php echo base_url(); ?>admin/settings/sliders">Trình chiếu hình
											ảnh</a>
									</li>
									<li>
					...
					<?php if ($isadmin && $role != "admin") {
						...
						<?php }
						if (pt_is_module_enabled('coupons')) { ?>
							<li>
					...
					<?php if (pt_permissions('locations', @$userloggedin)) { ?>
						<li>
							<a href="<?php echo base_url(); ?>admin/locations"><i class="fa fa-map-marker"></i>
								<span>Vị trí</span><span class="pull-right label label-danger" id=""></span>
							</a>
						</li>
					<?php } ?>
					<?php if ($isadmin) {
						if (pt_is_module_enabled('newsletter')) { ?>
					...
					<?php if ($isadmin) { ?>
						<?php if (pt_permissions('bookings', @$userloggedin)) { ?>
							<li>
								<a data-toggle="collapse" data-parent="#social-sidebar-menu" href="#EBOOKING"><i class="fa fa-gift"></i>
									<span>E - BOOKING</span><i class="fa arrow"></i>
								</a>
								<ul id="EBOOKING" class="collapse  wow fadeIn animated">
									<li><a href="<?php echo base_url(); ?>admin/bookings">Danh Sách</a></li>
									<li><a href="<?php echo base_url(); ?>admin/bookings/addcombo">Tạo Booking</a>
									</li>
									<li><a href="<?php echo base_url(); ?>admin/bookings/addhotel">Tao booking khách
											sạn</a>
									</li>
								</ul>
							</li>
					...
					<?php if ($isadmin) { ?>
						<?php if (pt_permissions('voucher', @$userloggedin)) { ?>
							<li>
								<a data-toggle="collapse" data-parent="#social-sidebar-menu" href="#EVOUCHER"><i class="fa fa-gift"></i>
									<span>E - VOUCHER</span><i class="fa arrow"></i>
								</a>
								<ul id="EVOUCHER" class="collapse  wow fadeIn animated  " style="height: auto;">
									<li><a href="<?php echo base_url(); ?>admin/voucher">Danh Sách</a></li>
									<li><a href="<?php echo base_url(); ?>admin/voucher/add_view">Tao Voucher</a></li>
								</ul>
							</li>
						<?php }
					} ?>
					<?php if ($isadmin) { ?>
					<li >
		              <a href="#yeucaukhach" data-parent="#social-sidebar-menu" data-toggle="collapse">
		                <i class="fa fa-list"></i>
		                <span>Yêu cầu khách</span><i class="fa arrow"></i>
		              </a>
		              <ul id="yeucaukhach" class="collapse  wow fadeIn animated" style="height: auto;">
		              <li><a href="<?php echo base_url(); ?>admin/request/all">Danh Sách yêu cầu</a></li>
		              <li><a href="<?php echo base_url(); ?>admin/request/flightbook">Đặt vé nhanh</a></li>
		              <li><a href="<?php echo base_url(); ?>admin/request/fastbook">Đặt phòng nhanh</a></li>

		               <li><a href="<?php echo base_url(); ?>admin/request/room_info">Khách hàng đặt phòng</a></li>
		               <li ><a href="<?php echo base_url(); ?>admin/request/room_info">Khách hàng đặt vé</a></li>
		            </ul>
		            </li>
            	   <?php } ?>
            	   ...
            	   <?php //if ($isadmin) { ?>
					<!-- <li >
		              <a href="#phanquyen" data-parent="#social-sidebar-menu" data-toggle="collapse">
		                <i class="fa fa-list"></i>
		                <span>Phân quyền</span><i class="fa arrow"></i>
		              </a>
		              <ul id="phanquyen" class="collapse  wow fadeIn animated" style="height: auto;">
		              <li><a href="<?php //echo base_url(); ?>admin/role/index">Danh sách quyền</a></li>
		              <li><a href="<?php //echo base_url(); ?>admin/role/add">Tạo quyền</a></li>
		              <li><a href="<?php //echo base_url(); ?>admin/rolepartner/index">Danh sách quyền đối tác</a></li>
		               <li><a href="<?php //echo base_url(); ?>admin/rolepartner/add">Tạo quyền đối tác</a></li>
		               <li ><a href="<?php //echo base_url(); ?>admin/customer">Danh sách khách hàng</a></li>
		               <li ><a href="<?php //echo base_url(); ?>admin/customer/add">Tạo khách hàng</a></li>
		            </ul>
		            </li> -->
            	   <?php //} ?>
