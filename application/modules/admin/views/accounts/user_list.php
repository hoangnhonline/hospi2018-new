<div class="container" id="content">
  ...
  <div class="clearfix"></div>
   ...
   <div class="panel-body" style="padding-top:5px;">
     ...
     <div class="box">    
     <a href="/admin/useradmin/taoquyen.html" style="background: #660033;margin-left: 15px;margin-top: 15px;" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm quyền ADMIN</a>   
