...
<div class="well well-sm">
<div class="row form-group">
<label  class="col-md-2 control-label text-left">Blog Logo</label>
<div class="col-md-4">
<div class="input-group input-xs">
<input type="file" class="btn btn-default" id="flogo" name="flogo">
<span class="help-block">Only PNG file supported</span>
</div>
</div>
<div class="col-md-4">
<img src="<?php echo PT_GLOBAL_IMAGES_FOLDER.'footer-logo.png?id='.rand(1,99);?>"  class="flogo_preview_img img-responsive" />
</div>
</div>
</div>
...
<div class="row form-group">
<label  class="col-md-2 control-label text-left">Front-end Mobile Pic</label>
<div class="col-md-2">
 <select data-placeholder="Select" class="form-control" name="mobpic">
<option value="Yes" <?php makeSelected('Yes',$settings[0]->mobile_pic_status); ?> >Enable</option>
<option value="No" <?php makeSelected('No',$settings[0]->mobile_pic_status); ?> > Disable</option>
</select>
</div>
<div class="col-md-3">
<input type="text" class="form-control" name="mobpicurl" placeholder="URL" value="<?php echo @$settings[0]->mobile_pic_url;?>" />
</div>
<small><strong>Enable this only if you want to show mobile image on front-end and your customers will be redirect to your speficied url. </strong></small>
</div>

<div class="row form-group">
<label  class="col-md-2 control-label text-left">Front-end Mob Redirect</label>
<div class="col-md-2">
 <select data-placeholder="Select" class="form-control" name="mobredirect">
<option value="Yes" <?php makeSelected('Yes',$settings[0]->mobile_redirect_status); ?> >Enable</option>
<option value="No" <?php makeSelected('No',$settings[0]->mobile_redirect_status); ?> > Disable</option>
</select>
</div>
<div class="col-md-3">
<input type="text" class="form-control" name="redirecturl" placeholder="URL" value="<?php echo @$settings[0]->mobile_redirect_url;?>" />
</div>
<small><strong>Enable this only if you want to redirect user visiting from mobile to your mobile app site url. </strong></small>
</div>
...
<div class="tab-pane wow fadeIn animated in" id="CONTACT">
  <div class="panel-body">
          ...
          <div class="row form-group">
<label class="col-md-2 control-label text-left">Support Number</label>
<div class="col-md-4">
              <input class="form-control input-sm" type="text" placeholder="Support Number" name="contact_phone" value="<?php echo $contact_data[0]->contact_phone;?>">
</div>
</div>
      <div class="row form-group">
<label class="col-md-2 control-label text-left">Tel</label>
<div class="col-md-4">
              <input class="form-control input-sm" type="text" placeholder="Phone Number" name="tel" value="<?php echo $contact_data[0]->tel;?>">
</div>
</div>
...
<div class="col-md-4">
              <input class="form-control input-sm" type="text" placeholder="Fax Number" name="fax" value="<?php echo $contact_data[0]->fax;?>">
</div>
</div>
