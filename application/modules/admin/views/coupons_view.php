...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="add_button_modal">
			<button type="button" data-toggle="modal" data-target="#ADD_COUPON" class="btn btn-success">
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="padding:0px">
				<form style="margin-top:10px" class="form-horizontal" method="POST" id="addcoupon" action="" onsubmit="return false;">
					...
					<div class="col-lg-5">
						<div class="well">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" placeholder="Value" class="form-control" name="rate" id="rate"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" placeholder="Start Date" class="form-control dpd1" name="startdate" id="stardate"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" placeholder="Expiration Date" class="form-control dpd2" name="expdate" id="expdate"/>
								</div>
							</div>
					...
					<div class="col-lg-7">
						...
						<div class="col-lg-12 well">
							<div class="input-group">
								<input type="text" name="code" id="codeadd" placeholder="Coupon Code" class="form-control input-lg code" value="">
								<span class="input-group-btn">
                        <button class="btn btn-primary btn-lg generate" id="add" type="button">Generate</button>
                        </span>
							</div>
						</div>
					...
					<?php foreach ($modules as $mod => $items): ?>
						<div class="col-md-12">
							<div class="form-group form-horizontal">
								<div class="col-md-2"><label class="required">Assign
										to <?php echo ucfirst($mod); ?></label></div>
								<div class="col-md-10">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary submitcoupon" id="#"><i class="fa fa-save"></i> Submit
					</button>
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="editCop<?php echo $cop->id; ?>" tabindex="" role="dialog" aria-labelledby="CouponModal" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
									...
									<div class="spacer20px">
										...
										<div class="col-lg-7">
											<div class="col-lg-12 well">
												...
												<div class="input-group">
													<?php foreach ($modules as $mod => $items): ?>
														<input type="checkbox" name="allmodules[]" value="<?php echo $mod; ?>" <?php if (pt_couponAssignedAllItems($cop->id, $mod)) {
															echo "checked";
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary editcoupon" id="<?php echo $cop->id; ?>">
