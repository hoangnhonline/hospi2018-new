  ...
  <div class="clearfix"></div>
   ...
   <div class="panel-body" style="padding-top:5px;">
    <div class="panel panel-default" style="margin-bottom:5px !important">
        <a href="/admin/khachhang/taokhachhang.html" style="background: #660033;margin-left: 15px;margin-top: 15px;" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm khách hàng</a>
        <div class="panel-body" style="padding-top: 15px;">
          <form class="form-inline" id="searchForm" role="form" method="GET" action="https://www.hospi.vn/admin/hotels">
            ...
            <input type="text" class="form-control" name="" placeholder="Mã khách hàng">            
              
            </div>   
            <div class="form-group">  
            <input type="text" class="form-control" name="" placeholder="Số điện thoai">            
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <tbody>
               <tr id="row-594" style="background: #e5e5e5">
                ...
                <td style="vertical-align: middle;">
                    <div class="sinhnhat">Gần sinh nhật</div>
                   27/12/2017
                 </td>
                  <td style="vertical-align: middle;">
                   27/12/2017,09:10PM
