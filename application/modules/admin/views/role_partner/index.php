<div class="container" id="content">
  ...
  <div class="clearfix"></div>
   ...
   <div class="panel-body" style="padding-top:5px;">
     ...
     <div class="box">    
     <a href="/admin/useradmin/taodanhsachquyendoitac.html" style="background: #660033;margin-left: 15px;margin-top: 15px;" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm quyền đối tac</a>   
            ...
            <tbody>
               <tr id="row-594" style="background: #e5e5e5">
                ...
                <td style="vertical-align: middle;">
                  ...
                  <td style="vertical-align: middle;">
                   <span style="color: #0099cc">chi tiết</span>
                 </td>
                <td style="vertical-align: middle;">
