...
";
        ...
        function hoteldetails() {
                ...
                $result = json_encode(array('title' => $hotel[0]->hotel_title, 'comm_type' => $comtype, 'comm_val' => (float)$comval, 'tax_type' => $taxtype, 'tax_val' => (float)$taxval, 'id' => $hotelid, 'btype' => 'hotels'));
                echo $result;
        }
