...
// add review by customer
    ...
    {
        $data = array(
            'review_booking_id' => $this->input->post('bookingid'),
            ...
            'review_anuong' => $this->input->post('reviews_anuong'),
            'review_staff' => $this->input->post('reviews_staff'),
            'review_facilities' => $this->input->post('reviews_facilities'),
            'review_location' => $this->input->post('reviews_location'),
            'review_comfort' => $this->input->post('reviews_comfort'),
            'review_overall' => $this->input->post('overall'),
...
// update review by Admin
    ...
    {
        $data = array('review_name' => $this->input->post('fullname'), 'review_comment' => $this->input->post('reviews_comments'), 'review_clean' => $this->input->post('reviews_clean'), 'review_staff' => $this->input->post('reviews_staff'), 'review_anuong' => $this->input->post('reviews_anuong'), 'review_facilities' => $this->input->post('reviews_facilities'), 'review_location' => $this->input->post('reviews_location'), 'review_comfort' => $this->input->post('reviews_comfort'), 'review_overall' => $this->input->post('overall'), 'review_email' => $this->input->post('email'));
        $this->db->where('review_id', $id);
        $this->db->update('pt_reviews', $data);
    }
