...
// update general setting
		function update_settings() {
				...
				$mobilePicStatus = $this->input->post('mobpic');
				$mobilePicUrl = $this->input->post('mobpicurl');
				$mobileRedirectStatus = $this->input->post('mobredirect');
				$mobileRedirectUrl = $this->input->post('redirecturl');
				...
				$data = array('offline_message' => $this->input->post('offlinemsg'),'rss' => $this->input->post('rss'),'default_theme' => $this->input->post('theme'),'site_offline' => intval($this->input->post('site_offine')), 'site_title' => $this->input->post('site_title'), 
					'site_url' => $this->input->post('site_url'), 'ssl_url' => $sslUrl,  'license_key' => $this->input->post('license'), 'site_name' => $this->input->post('site_name'), 'tag_line' => $this->input->post('tag_line'), 
					'address' => $this->input->post('address'), 'phone' => $this->input->post('phone'), 'copyright' => $this->input->post('copyright'), 'reviews' => $this->input->post('reviews'), 'gallery_approve' => $galleryApprove, 'video_uploads' => $this->input->post('videouploads'), 
					'default_lang' => $this->input->post('default_lang'), 'multi_lang' => intval($this->input->post('multi_lang')), 'default_city' => $this->input->post('default_city'), 'date_f' => $dateformat, 'date_f_js' => $jsdate, 'booking_expiry' => $expiry, 'booking_cancellation' => $cancel, 
					'coupon_code_length' => $codelength, 'coupon_code_type' => $this->input->post('coupon_code_type'), 'searchbox' => $this->input->post('searchbox'), 'allow_registration' => intval($this->input->post('allow_registration')),'user_reg_approval' => $this->input->post('user_reg_approval'), 
					'allow_supplier_registration' => intval($this->input->post('allow_supplier_registration')), 'multi_curr' => intval($this->input->post('multicurr')), 'updates_check' => intval($this->input->post('updates')), 'restrict_website' => $this->input->post('restrict'), 'mobile_pic_status' => $mobilePicStatus,'mobile_pic_url' => $mobilePicUrl,
					'mobile_redirect_status' => $mobileRedirectStatus,'mobile_redirect_url' => $mobileRedirectUrl, 'mapApi' => $mapApi );
				$this->db->where('user', 'webadmin');
				$this->db->update('pt_app_settings', $data);
