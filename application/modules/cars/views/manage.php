      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <div class="row form-group">
              ...
              <select  class="form-control chosen-select" name="cartype">
                ...
                <?php  } } ?>
                        ...
                        <div class="row form-group">
                                    ...
                                    <?php  for($i=1; $i<=10; $i++) { $price = ""; ?>

            <label class="col-md-2 control-label text-left">Pick Up Location</label>
            <div class="col-md-3">
              <select name="locations[<?php echo $i; ?>][pickup]" class="chosen-select">
                <option value="">Select</option>
                <?php foreach($locations as $loc){ $ispickup = carLocationsInfo($i, @$loc->id,$carid,"pickup"); ?>
                <option value="<?php echo $loc->id; ?>" <?php if($ispickup->isPickup){ $price = $ispickup->price; echo "selected"; }; ?> ><?php echo $loc->location;?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <div class="col-md-3">
              <select name="locations[<?php echo $i; ?>][dropoff]" class="chosen-select">
                <option value="">Select</option>
                <?php foreach($locations as $locc){ $isdropoff = carLocationsInfo($i, @$locc->id,$carid,"dropoff"); ?>
                <option value="<?php echo $locc->id; ?>" <?php if($isdropoff->isDropoff){ $price = $isdropoff->price; echo "selected"; }; ?> ><?php echo $locc->location;?></option>
                <?php } ?>
              </select>
            </div>
       ...
       <!-- <div class="panel panel-default">
        ...
        <div class="tab-pane wow fadeIn animated in" id="TRANSLATE">
          <?php foreach($languages as $lang => $val){ if($lang != "vi"){ @$trans = getBackCarTranslation($lang,$carid); ?>
          <div class="panel panel-default">
