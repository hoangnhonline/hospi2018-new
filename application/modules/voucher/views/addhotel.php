                                          ...
                                          <div class="panel panel-default">
                                            ...
                                            <div class="panel-body" style="padding-top: 15px">
                                              ...
                                              <form role="form" class="form-horizontal">
                                                <div class="col-md-7">
                                                       <div class="form-group">
                                                          <label for="select-standard" class="control-label col-md-5 font-weight-unset">Tạo mã khách sạn</label>
                                                         <div class="col-md-7">
...
<script type="text/javascript">
    ...
    $("select#hotels_select").change(function () {
        ...
        url = "<?php echo base_url();?>admin/voucher/hotelChange?hotel_id=" + $(this).val() +data;//alert(url);
        $.ajax({
   ...
   function addRoom(){
       ...
       data ="&" + data +  "&checkin="  +checkin + "&checkout="  +checkout ;
               url = "<?php echo base_url();?>admin/voucher/addRoom?hotel_id=" +hotel_id+data ;//alert(url);
  ...
  function removeRoom(roomId) {
     ...
     url = "<?php echo base_url();?>admin/voucher/delRoom?room_id=" +roomId+ data ;//alert(url);
        $.ajax({
            url: url, success: function (result) {//alert(result);
               $("#education-box").html(result);
                //$("#hotels_select").html(result);
